...
const CheckBox = ({label,typeCheck,name,onChange,value}) => {
    return (
        <>
            <input className="w-6 h-6 rounded-full" type={typeCheck} name={name} onChange={onChange} value={value}/>
...
const Filtre = props => {
    ...
    return(
        <div className="mt-24">
            <img src={cross} onClick={props.closeFilter} className="w-7 cursor-pointer absolute top-16 right-3" alt="cross"/>
            ...
            <div className="">
                ...
                <div className="flex justify-center">
                    <span className="mr-3 whitespace-nowrap mt-1 bish-text-gray">Prix : </span>
                    <CustomSlider
                        value={value}
                        step={10}
                        min={0}
