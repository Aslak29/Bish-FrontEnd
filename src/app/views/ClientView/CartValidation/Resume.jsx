...
import {selectDeliveryAddress, selectIdPaymentIntent} from '../../../redux-store/cartSlice';
    ...
    return (
        <div className='my-10 space-y-10'>
            <div className='flex flex-col md:flex-row place-items-end md:place-items-start'>
                ...
                <div
                    className='w-full sm:w-1/2 md:w-1/3 bish-bg-gray-shop shadow p-5 flex flex-col justify-between my-10 md:my-0'>
                    ...
                    <div className='flex flex-col gap-y-2'>
                        <div className='flex flex-col gap-y-2'>
                            ...
                            <div className='flex flex-row gap-x-2'>
                                ...
                                <button
                                    className='w-1/5 rounded border bish-border-blue hover:bish-bg-blue-opacity py-2'>
