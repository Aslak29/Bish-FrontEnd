...
export const URL_ADMIN_STATS = '/admin/statistiques';
...
export const URL_STATISTIQUE_USER = '/admin/statistiques/user'

export const URL_STATISTIQUE_PRODUITS = '/admin/statistiques/produits'
